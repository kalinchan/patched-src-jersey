...
class RxTestInvoker extends AbstractRxInvoker<Future> implements RxFutureInvoker {
    ...
    public RxTestInvoker(final Invocation.Builder builder, final ExecutorService executor) {
    ...
    @Override
    public <R> Future<R> method(final String name, final Entity<?> entity, final GenericType<R> responseType) {
